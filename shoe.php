...
<body> <div class="main">
 ...
 <?php 
   $x=0;
 include 'db.php';
 $sql="select thing.thingname,thing.username,thing.price,thing.modelno,pic.img from thing  INNER JOIN pic ON thing.modelno=pic.modelno  WHERE thing.category='Shoe'";
